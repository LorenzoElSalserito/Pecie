...
const generatedDeclarationFilePath = resolve(process.cwd(), 'packages/schemas/src/generated/types.generated.d.ts')
...
await writeFile(generatedDeclarationFilePath, content, 'utf8')
